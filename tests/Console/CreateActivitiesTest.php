...
class CreateActivitiesTest extends TestCase
{
    ...
    /** @test */
    public function it_should_create_activity_on_user_anniversary_even_if_user_was_created_later_that_day()
    {
        $user = factory(User::class)->create(['created_at' => now()->addHour()->subYear()]);
