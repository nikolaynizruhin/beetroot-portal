        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <i class="fas fa-file-alt fa-lg fa-fw" aria-hidden="true"></i>
                    &nbsp;
                    Privacy Policy
                </div>

                <div class="card-body">
                    <h3>Privacy Policy of family.beetroot.se</h3>
                    ...
                    <p>Among the types of Personal Data that this Application collects, there are: name, avatar, email, job position, birthday, phone, slack, skype, github, bio, first day at beetroot, client, office.</p>
                    ...
                    Personal Data filled in by the company's employees.
                    Any use of Cookies – by this Application used by this Application serves the purpose of providing the Service required by the User, in addition to any other purposes described in the present document and in the Cookie Policy, if available.</p>
                    ...
                    <p>Personal Data:  name, avatar, email, job position, birthday, phone, slack, skype, github, bio, first day at beetroot, client, office.</p>

                    <p>When a user becomes an employee of a Beetroot AB, his data is stored in the portal so that other employees have information about their teammates.</p>
                    ...
                    <p>This Application uses Cookies to save the User's session and to carry out other activities that are strictly necessary for the operation of this Application.</p>
