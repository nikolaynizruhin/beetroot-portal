                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('clients.update', $client->id) }}">
                        ...
                        <div class="form-group{{ $errors->has('location') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="location" type="text" class="form-control" name="location" value="{{ old('location', $client->location) }}" required>
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control" name="description" value="{{ old('description', $client->description) }}" required>
